...
public class Main {
    public static void main(String[] args) {
        ...
        CuentaComitente cuentaComitente1 = new CuentaComitente(cliente1,243000005, "Aconcagua", 15000, "SilvioSoldan");
        ...
        cuentaComitente1.informarSaldo();
        cuentaComitente1.depositar(10000);
        cuentaComitente1.informarSaldo();

        System.out.println("----------------------------------------");
        cuentaComitente1.informarSaldo();
        cuentaComitente1.extraer(12500);
        cuentaComitente1.informarSaldo();

        System.out.println("----------------------------------------");
        cuentaComitente1.informarSaldo();
        cuentaComitente1.extraer(10000, "Domingo");
        cuentaComitente1.informarSaldo();
    }
}